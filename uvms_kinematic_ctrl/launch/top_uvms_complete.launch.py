...
def generate_launch_description():
    ...
    tf_tree_model_path = str(sim_package_path /
                             'models/urdf/uvms_rviz.urdf.xacro')
    ...
    bluerov_acceleration_estimation_path = get_package_share_path(
        'bluerov_estimation')
    mixer_path = str(bluerov_low_level_ctrl_path /
    ...
    alpha_force_torque_calc = launch.actions.IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            str(use_hydro),
            'base_tf_file':
            str(alpha_model_path / 'config/alpha_base_tf_params_bluerov.yaml'),
            'moving_base':
            str(True),
            'use_sim_time':
            str(use_sim_time)
    ...
    bluerov_acceleration_estimation = launch.actions.IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            str(bluerov_acceleration_estimation_path /
    ...
    bluerov_ctrl = launch.actions.IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            str(1),
            'config_file':
            str(bluerov_ctrl_path / 'config/ctrl_params_real_uvms.yaml'),
        }.items())
